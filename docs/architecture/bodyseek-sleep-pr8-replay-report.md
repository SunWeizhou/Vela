...
`recentBedtimesHistory` input.

Canonical fingerprint:

`sleep-v2|2026-07-31T12:00:00Z|465|450|awake=24|episodes=2|bedtime=nil|history=0`

Expected output is `77.43` (tolerance `0.01`), medium confidence, duration
component `50.0`, interruption component `4.2`, and missing input
`recentBedtimesHistory`. The algorithm version remains `sleep.v2.0.0`.

## Sensitivity evidence

| Case | Single controlled change | Value | Confidence | Missing inputs |
| --- | --- | ---: | --- | --- |
| baseline | none | 77.43 | medium | recentBedtimesHistory |
| short-sleep-360 | total sleep = 360 min | 53.62 | medium | recentBedtimesHistory |
| no-awake-time | awake = 0, episodes = 0 | 100.00 | medium | recentBedtimesHistory |
| missing-awake-time | awake and episodes unavailable | 79.00 | low | recentBedtimesHistory, awakeMinutes |
