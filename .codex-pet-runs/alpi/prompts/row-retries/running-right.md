Create Codex pet row `running-right` for `alpi`: exactly 8 full-body frames in one horizontal strip on flat pure user-selected #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Small pixel-art alpaca pet, cream wool, tan face and ears, black dot eyes, tiny smile, teal scarf, compact chibi proportions, readable at 192x208, no text or logos.. Preserve silhouette, face, palette, material, proportions, markings, and props.
